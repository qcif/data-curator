          ...
          <div id="csvEditor">
            <ul class="nav nav-tabs">
              ...
              <li
                ...
                <a>&nbsp;<button
                  type="button"
                  class="btn btn-sm"><i class="fa fa-plus"/></button>
                </a>
              </li>
...
import { addHotContainerListeners, getWindow, loadData } from '../index.js'
import { disableEnableContextMenu } from '../menu.js'
import { getColumnCount, getCurrentColumnIndexOrMin, HotRegister, resetTabMoves } from '../hot.js'
...
import { guessColumnProperties, validateActiveDataAgainstSchema } from '../frictionless.js'
