...
export default {
  ...
  components: {
    ...
    'tooltipColumnName': {
      ...
      <externalLink text="Name" url="http://specs.frictionlessdata.io/table-schema/#name"/> Usually the value of the first row in the column.</div>`
    },
    'tooltipColumnTitle': {
      components: {externalLink},
      template: `<div id="tooltip-column-title">A human readable
      <externalLink text="Title" url="http://specs.frictionlessdata.io/table-schema/#title"/> for the column.</div>`
    },
